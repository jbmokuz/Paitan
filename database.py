...
def createTenhouGame(replayId, scores, rate, roundNumber=0):
    ...
    name0, score0, payout0, shugi0, binghou0, kan0 = scores[0].getList()
    name1, score1, payout1, shugi1, binghou1, kan1 = scores[1].getList()
    name2, score2, payout2, shugi2, binghou2, kan2 = scores[2].getList()
    if len(scores) > 3 :
        name3, score3, payout3, shugi3, binghou3, kan3 = scores[3].getList()
    else:
        name3 = None
        score3 = None
        shugi3 = None
